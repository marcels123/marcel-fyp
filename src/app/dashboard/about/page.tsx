...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col items-center w-full text-gray-800 bg-[#f4f3fc]">
      {/* Hero Section */}
      ...
      {/* Aim Section */}
      <section className="w-full py-16 bg-[#f4f3fc]">
      ...
      <section className="w-full py-16 bg-[#f4f3fc]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          {isAuthenticated ? (
            <>
              <h2 className="text-3xl font-semibold mb-4">Ready to continue your AI journey?</h2>
              <p className="text-lg mb-8">
                Explore demos, test your knowledge, and learn more about AI's role in digital creativity.
              </p>
              <Link href="/dashboard">
